...
const styleConfigs = {
    ember: {
        ...
        noiseFrequency: 2.2,
        edgeWidth: 0.12,
        edgeColor: new Color(6, 1.5, 0.2), // hot orange
    ...
    plasma: {
        ...
        noiseFrequency: 5.0,
        edgeWidth: 0.08,
        edgeColor: new Color(0.3, 2.0, 8), // electric blue
        liftDirection: new Vec3(0, 1, 0),
        liftDistance: 0.25,
        waveAmplitude: 0.1,
        waveFrequency: 10
    ...
    mist: {
        ...
        noiseFrequency: 1.2,
        edgeWidth: 0.35,
        edgeColor: new Color(2, 2, 2.5), // soft white
        liftDirection: new Vec3(0, 1, 0),
        liftDistance: 1.2,
        waveAmplitude: 0.15,
        waveFrequency: 3
    ...
    smooth: {
        ...
        edgeWidth: 0.25,
        edgeColor: new Color(1.5, 6, 2), // green
        liftDirection: new Vec3(0, 1, 0),
        liftDistance: 0.8,
        waveAmplitude: 0.1,
        waveFrequency: 4
...
const roomAabbMin = new Vec3(-50, -5, -50);
const roomAabbMax = new Vec3(50, 5, 50);
